...
Vagrant.configure("2") do |config|
  ...
  config.vm.define :puppet do |puppet|
    puppet.vm.network :private_network, ip: "172.16.56.10", netmask: "255.255.255.0"
  ...
  config.vm.define :web do |web|
    web.vm.network :private_network, ip: "172.16.56.11", netmask: "255.255.255.0"
  ...
  config.vm.define :db do |db|
    db.vm.network :private_network, ip: "172.16.56.12", netmask: "255.255.255.0"
